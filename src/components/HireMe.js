...
export default function HireMe() {
 return (
   <div className="fixed left-10 bottom-10 flex items-center justify-center tablet:left-5 tablet:bottom-5 hover:scale-105 transition-all duration-200 ease-linear">
